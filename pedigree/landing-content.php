            ...
            <div class="main-block__text">
                <div class="text-wrapper">
                    ...
                    <div class="main-block__buttons">
                        <a href="puppies.php" class="button but-puppy">
                            Посмотреть щенков
                        </a>
                        <a href="about.php" class="button but-moreabout">
                            Подробнее о породе
                        </a>
                    </div>
                </div>
    ...
    <div class="feature container work">
        <div class="feature__videoes tabs">
            <ul class="feature__video-main work__video-main " >
                <li class="video-content tab-content active" data-youtube="EatqsMH8reA">

<!--                    <iframe width="100%" height="100%" src="https://www.youtube.com/embed/EatqsMH8reA?autoplay=0&amp;rel=0&amp;enablejsapi=1" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>-->
<!--                    -->
                    <img class="play" src="img/play.svg" alt="play">
                </li>
                <li class="video-content tab-content" data-youtube="fO3fybJqjv0">
<!--                    <iframe width="100%" height="100%" src="https://www.youtube.com/embed/fO3fybJqjv0?autoplay=0&amp;rel=0&amp;enablejsapi=1" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>-->
<!--                    -->
                    <img class="play" src="img/play.svg" alt="play">
                </li>
            </ul>
            ...
            <ul class="work__video-sub sub-pic tabs-caption">
                <li class="active">
                    <img src="img/work-sub1.jpg" alt="Video-sub">

                </li>
                <li>
                    <img src="img/work-sub2.jpg" class="worksub2" alt="Video-sub">
    ...
    <div class="feature simple-grow">
        ...
        <div class="feature__description simple-grow__description ">
            ...
            <p class="feature__text simple-grow__text"  >
                В последнее время наблюдается тенденция на укрупнение породы, излишнюю массивность. Чрезмерная массивность и стремительный рост негативно влияют на формирование костяка щенка. Особенно в таких случаях подверженны заболеванию суставы. Вес и рост наших собак колеблется в рамках стандарта, но не превышают его. Отчасти, благодаря этому, за 15 лет работы с нашими породными линиями не было ни одного случая заболевания дисплазией или других паталогий суставов.
            </p>
        </div>
    </div>
    ...
    <div class="feature we-white indent-left">
        <div class="feature__description">
            <div class="feature__heading we-white__heading">
                ...
                <img class="we-white__smile" src="img/smile.svg" alt="Smile">
            </div>
...
<section class="our-dogs" id="our-dogs">
    <div class="container">
        ...
        <div class="parents">
            ...
            <div class="slider-parents">
                <img src="img/Alellopedigree.jpg" alt="AkeloPedigree">
                <img src="img/GeraPedigree.jpg" alt="GeraPedigree">
            </div>
        </div>
        <div class="growingup-dogs">
            ...
            <div class="growingup-dogs__block">
                ...
                <div class="growingup-dogs__dog nezhna">
                    <img src="img/nezhna.jpg" alt="Nezhna">
                    <div class="dog__description">
                        <h5 class="dog__name">
        ...
        <div class="contacts-wrapper">
            ...
            <div class="contacts__text">
                ...
                <div class="contacts__string socials">
                    <a href="viber://chat?number=%2B380933195195" target="_blank">
                        <img class="social" src="img/viber.svg" alt="ICON">
                    </a>
                    <a href="tg://resolve?domain=bodya_f1" target="_blank">
                        <img class="social" src="img/telegram.svg" alt="ICON">
                    </a>
                </div>
                <div class="contacts__string socials">
                    <img class="social" src="img/email.svg" alt="ICON">
                ...
                <div class="contacts__string socials">
                     <a href="https://www.facebook.com/profile.php?id=100007025417042" target="_blank" >
                         <img class="social" src="img/facebook-white.svg" alt="ICON">
                     </a>
                     <a href="https://www.youtube.com/channel/UC3kQoM1j52HinM1C-9uyxjQ" target="_blank">
                         <img class="social" src="img/youtube-white.svg" alt="ICON">
                     </a>
                     <a href="https://www.instagram.com/yuliaakita" target="_blank">
                         <img class="social" src="img/instagram-white.svg" alt="ICON">
                     </a>
                </div>
